        ...
        JsonAdapter {
            ...
            property JsonObject appearance: JsonObject {
                ...
                property JsonObject wallpaperTheming: JsonObject {
                    property JsonObject masterTheme: JsonObject { 
                        property bool enable: true 
                        property string jsonPath: "~/.config/illogical-impulse/themes/petrified_spittoon.json" 
            ...
            property JsonObject background: JsonObject {
                ...
                property JsonObject perMonitorWallpaper: JsonObject {}
